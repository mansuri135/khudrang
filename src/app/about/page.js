    ...
    <div>
      ...
      <section className="mb-16 text-center">
        ...
        <p className="text-lg leading-relaxed max-w-3xl mx-auto">
          Khudrang serves as a vibrant platform for artists, offering them an opportunity to showcase their poetic talent. The foundation organizes various events, including open mics, nashidhs, mushairas, and more, helping foster a creative environment for poetry lovers and performers alike.
        </p>
      </section>
...
His poetry, particularly the famous ghazal "Nayi Zameen Naya Aasmaan, He Hi Nahi, Jahan Mein Dusra Hindustan, He Hi Nahi," resonates deeply with poetry lovers in Ahmedabad and beyond. Known for his distinct style of reciting poetry, Sahib has performed across all formats, including open mics, mushairas, and nashidhs.
